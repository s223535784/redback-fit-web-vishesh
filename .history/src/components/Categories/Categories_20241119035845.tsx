...
import runnerIcon from '../../assets/runner1.png';
...
const categories: Category[] = [
    {
      ...
      badges: [
        ...
        { name: 'Sprint Champion', icon: <img src={runnerIcon} alt="Running Icon" style={{ width: '124px', height: '124px' }} />, tooltip: 'Sprint as fast as you can' },
