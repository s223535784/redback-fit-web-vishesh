...
const categories: Category[] = [
    {
      ...
      badges: [
        ...
        { name: 'Pace Master', icon: <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><img src={runnerIcon1} alt="Running Icon" style={{ width: '124px', height: '124px' }} /><span style={{ marginTop: '8px', fontSize: '14px', color: 'white', fontWeight: 'bold' }}>Pace Mastr</span></div>, tooltip: 'Master your pace with precision tracking!' },
