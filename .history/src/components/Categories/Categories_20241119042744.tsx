...
const categories: Category[] = [
    {
      ...
      badges: [
        ...
        { name: 'Pace Master', icon: <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><img src={runnerIcon1} alt="Running Icon" style={{ width: '124px', height: '124px' }} /><span style={{ marginTop: '8px', fontSize: '14px', color: 'white', fontWeight: 'bold' }}>Pace Master</span></div>, tooltip: 'Master your pace with precision tracking!' },
        { name: 'Pace Master', icon: <div style={{ display: 'flex', alignItems: 'center' }}><span style={{ marginRight: '8px', fontSize: '14px', color: 'white', fontWeight: 'bold' }}>Pace Master</span><img src={runnerIcon1} alt="Running Icon" style={{ width: '124px', height: '124px' }} /></div>, tooltip: 'Master your pace with precision tracking!' },
        { name: 'Pace Master', icon: <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><img src={runnerIcon1} alt="Running Icon" style={{ width: '124px', height: '124px' }} /><span style={{ marginTop: '8px', fontSize: '14px', color: 'white', fontWeight: 'bold' }}>Pace Master</span></div>, tooltip: 'Master your pace with precision tracking!' },
        { name: 'Pace Master', icon: <div style={{ display: 'flex', alignItems: 'center' }}><span style={{ marginRight: '8px', fontSize: '14px', color: 'white', fontWeight: 'bold' }}>Pace Master</span><img src={runnerIcon1} alt="Running Icon" style={{ width: '124px', height: '124px' }} /></div>, tooltip: 'Master your pace with precision tracking!' },
        ...
        { name: 'Sprint Champion', icon: <div style={{ display: 'flex', alignItems: 'center' }}><img src={runnerIcon2} alt="Running Icon" style={{ width: '124px', height: '124px' }} /><span style={{ marginLeft: '8px', fontSize: '14px', color: '#333', fontWeight: 'bold' }}>Sprint Champion</span></div>, tooltip: 'Sprint as fast as you can' }

        { name: 'Pace Master', icon: <div style={{ display: 'flex', alignItems: 'center' }}><img src={runnerIcon1} alt="Running Icon" style={{ width: '124px', height: '124px' }} /><span style={{ marginLeft: '8px', fontSize: '14px', color: 'white', fontWeight: 'bold' }}>Pace Master</span></div>, tooltip: 'Master your pace with precision tracking!' },
        ...
        { name: 'Sprint Champion', icon: <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><img src={runnerIcon2} alt="Running Icon" style={{ width: '124px', height: '124px' }} /><span style={{ marginTop: '8px', fontSize: '14px', color: '#333', fontWeight: 'bold' }}>Sprint Champion</span></div>, tooltip: 'Sprint as fast as you can' },
