...
const Categories: React.FC = () => {
  ...
  const App = () => {
    // Function to play text as speech when clicked
    const playAudio = () => {
      const message = "Welcome to the Categories Page. Click to hear about our features and badges.";
      
      // Create a new speech synthesis utterance
      const speech = new SpeechSynthesisUtterance(message);
  
      // Optionally, you can set parameters like the language, voice, rate, pitch
      speech.lang = 'en-US'; // Set the language (you can change to 'en-GB' for British accent, for example)
      speech.rate = 1; // Speed of the speech (1 is normal, 0.5 is slower, 1.5 is faster)
    ...
    return (
      <div>
        ...
        <div
          ...
          onClick={playAudio} // Trigger playAudio function on click
        >
          <p style={{
            margin: 0,
