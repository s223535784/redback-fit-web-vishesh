...
const categories: Category[] = [
  {
    ...
    badges: [
      { name: 'Pace Master' icon={<img src={runningIcon} alt="Running Icon" style={{ width: '24px', height: '24px' }}  />, tooltip: 'Master your pace with precision tracking!' }, // Adding tooltip for hover effect
      { name: 'Marathon Pro', icon: <FaRunning /> imageSrc: '/path/to/your/image1.png', },
