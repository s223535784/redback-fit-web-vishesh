...
const categories: Category[] = [
    {
      ...
      badges: [
        { name: 'Pace Master', icon: <img src={runnerIcon} alt="Running Icon" style={{ width: '24px', height: '24px' }} />, tooltip: 'Master your pace with precision tracking!' }, // Adding tooltip for hover effect
