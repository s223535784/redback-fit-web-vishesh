...
import test1Audio from '../../assets/Welcome.m4a';
    ...
    const categories: Category[] = [
          {
            ...
            description:<p>asdfasdf</p>'Track your running performance and elevate your fitness with in-depth analytics and tools designed for runners of all levels. Monitor and evaluate key performance metrics such as your pace, stride length, and ground contact time to optimize your technique and reduce the risk of injury. Stay informed about your heart rate during runs to understand your effort levels and ensure you are training in the correct zones for your goals, whether improving endurance, building speed, or achieving personal bests. Personalized goal-setting features enable you to set milestones and measure progress, keeping you motivated and on track throughout your fitness journey.',
